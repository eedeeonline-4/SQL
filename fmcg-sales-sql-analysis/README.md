...
## Project Overview
This project analyzes FMCG sales transactions using SQL to uncover revenue trends, top products, top customers, and regional performance.
...
Calculate profit over the month.
